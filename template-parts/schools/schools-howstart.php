    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 cta__center">
                <button id="signup_popup_open__try_it_now" data-submit="signup_submit__try_it_now" data-close="signup_popup_close__try_it_now" data-from="Schools try it now" data-micromodal-trigger="cta" class="cta cta__black"><?php esc_html_e('Leave a request', 'ieverly'); ?></button>
            </div>
        </div>
    </div>
</section>