            ...
            <div class="col-12">
                <div class="price__list">
                    <div class="price__box price__free">
                        ...
                        <button id="signup_popup_open__prices_start_for_free" data-submit="signup_submit__prices_start_for_free" data-close="signup_popup_close__prices_start_for_free" data-from="Home prices - start for free" data-micromodal-trigger="cta" class="cta cta__black"><?php esc_html_e('Start', 'ieverly'); ?></button>
                    </div>
                    ...
                    <div class="price__box price__final">
                        ...
                        <button id="signup_popup_open__prices_contact_us" data-submit="signup_submit__prices_contact_us" data-close="signup_popup_close__prices_contact_us" data-from="Home prices - contact us" data-micromodal-trigger="cta" class="cta cta__blue"><?php esc_html_e('Contact us', 'ieverly'); ?></button>
                    </div>
                </div>
            </div>
        </div>
